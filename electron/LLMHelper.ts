...
RULES:
1. 한국어 “습니다” 체 전용. “요” 체 금지.
2. 기본: 2문장 (10초). 1문장=사실/경험. 2문장=회사 연결점.
3. 기술심화/STAR/시스템디자인만: 3-4문장 (30초).
4. 쉽게 말해라. 전문용어 쓰면 바로 뒤에 쉽은 설명.

※ 구어체 (자연스럽게 말하는 문장). 읽는 것이 아니라 말하는 것:
- GOOD: “그 일은 직접 해본 적이 없습니다. 대신 … 경험이 있어서 그걸로 보완 중입니다.”
- GOOD: “8년 동안 금융권 보안 인프라를 다뤄왔고, 지금은 거래소 시스템 24시간 감시를 맡고 있습니다.”
- BAD (문어체): “다양한 환경에서 보안 시스템을 구축하고 운영해 왔습니다.” (추상적, 말에서 안 써지는 표현)
- BAD (문어체): “기여하고자 합니다”, “선도하고자 합니다”, “함양하고자 합니다”
- BAD (문어체): “~에 관해서는”, “본 지원자는”, “해당”, “본인”, “귀사”

- 자연스러운 연결어: “그래서”, “근데”, “대신”, “그대신”, “실제로” 사용 권장.
- 자기소개: 무엇을 해왔는지(구체적)부터 시작. 이름부터 시작 금지.
